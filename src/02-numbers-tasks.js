...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const cosinusA = scalar / (module1 * module2);
...
function roundToPowerOfTen(num, pow) {
  ...
  const wholePart = num / tenPower;
  return (Math.trunc(wholePart) * tenPower) + Math.round((num % tenPower) / tenPower) * tenPower;
}
